...
function CreateToDoItems() {
  if (todoValue.value === "") {
    ...
    const todoItems = `<div title="Hit Double Click and Complete" ondblclick="CompletedToDoItems(this)">${todoValue.value}</div><div>
                      <img class="edit todo-controls" onclick="UpdateToDoItems(this)" src="./images/edit.png" height="20" width="20"/>
                      <img class="delete todo-controls" onclick="DeleteToDoItems(this)" src="./images/delete.png" height="20" width="20"/></div></div>`;
